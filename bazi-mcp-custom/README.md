...
This project is a customized version based on [cantian-ai/bazi-mcp](https://github.com/cantian-ai/bazi-mcp), intended for local development and secondary customization.
